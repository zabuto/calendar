        ...
        function drawEvents($calendarElement, type) {            
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    $dowElement.data('eventsCount', $dowElement.data('eventsCount') ? $dowElement.data('eventsCount') + 1 : 1);
                    
                    var eventsArr = $dowElement.data('events') || [];
                    eventsArr.push(value);                    
                    
                    $dowElement.data('events', eventsArr);                    
